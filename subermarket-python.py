...
class Super:
    def __init__(self,root):
        ...
        self.root.title('Super-Market: احمد سيد')
        self.root.resizable(True,True)
        #self.root.iconbitmap('D:\\icone.ico') الايقون
        title = Label(self.root , text='سوبر ماركت احمد سيد',fg='white',bg='#0B2F3A',font=('tajawal',15))
        title.pack(fill=X)
        # ========= Variable ================
        self.q1=IntVar()
        self.q2=IntVar()
        ...
        #======== Price =============
        F4 = Frame(root,bd=2,width=657,height=112,bg='#00ff99')
        F4.place(x=641,y=587)
        hesab=Button(F4,text='الحساب',width=13,height=1,font='tajawal',bg='#00ff99',command=self.total)
        hesab.place(x=537,y=10)
        fatora=Button(F4,text='تصدير فاتورة',width=13,height=1,font='tajawal',bg='#00ff99',command=self.billing)
        fatora.place(x=537,y=55)
        clear=Button(F4,text='افراغ الحقول',width=13,height=1,font='tajawal',bg='#00ff99',command=self.clear)
        clear.place(x=417,y=10)
        exite=Button(F4,text='اغلاق البرنامج',width=13,height=1,font='tajawal',bg='#00ff99')
        exite.place(x=417,y=55)
        lblo1=Label(F4,text='حساب الكلي للكتب',font=('tajawal',10,'bold'),bg='#00ff99',fg='black')
        lblo1.place(x=220,y=10)
        lblo2=Label(F4,text='حساب الدوات المدرسية',font=('tajawal',10,'bold'),bg='#00ff99',fg='black')
        lblo2.place(x=220,y=40)
        lblo3=Label(F4,text='حسـاب ',font=('tajawal',10,'bold'),bg='#00ff99',fg='black')
        ...
        #======== Tools[1] ============
        FF1 = Frame(root,bd=2,width=318,height=664,bg='#0086b3')
        FF1.place(x=1,y=35)
        t = Label(FF1,text='الـبقوليات',font=('tajawal',13,'bold'),bg='#0086b3',fg='black')
        t.place(x=120,y=0)
